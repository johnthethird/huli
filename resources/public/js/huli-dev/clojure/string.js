...
{{
var G__15335 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15335;
continue;
}
} else
...
{var pred__15339 = cljs.core._EQ_;var expr__15340 = limit;if(cljs.core.truth_(pred__15339.call(null,1,expr__15340)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__15339.call(null,2,expr__15340)))
...
var G__15342 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15343 = (limit__$1 - 1);
var G__15344 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__15342;
limit__$1 = G__15343;
parts = G__15344;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___15346 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___15346))
{var replacement_15347 = temp__4090__auto___15346;buffer.append([cljs.core.str(replacement_15347)].join(''));
} else
{buffer.append(ch);
}
{
var G__15348 = (index + 1);
index = G__15348;
continue;
}
}
