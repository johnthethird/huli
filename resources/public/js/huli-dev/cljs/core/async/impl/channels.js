...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t17945 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t17945 = (function (val,box,meta17946){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t17945.cljs$lang$type = true;
cljs.core.async.impl.channels.t17945.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t17945";
cljs.core.async.impl.channels.t17945.cljs$lang$ctorPrWriter = (function (this__4033__auto__,writer__4034__auto__,opt__4035__auto__){return cljs.core._write.call(null,writer__4034__auto__,"cljs.core.async.impl.channels/t17945");
});
cljs.core.async.impl.channels.t17945.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t17945.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17947){var self__ = this;
var _17947__$1 = this;return self__.meta17946;
});
cljs.core.async.impl.channels.t17945.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17947,meta17946__$1){var self__ = this;
var _17947__$1 = this;return (new cljs.core.async.impl.channels.t17945(self__.val,self__.box,meta17946__$1));
});
cljs.core.async.impl.channels.__GT_t17945 = (function __GT_t17945(val__$1,box__$1,meta17946){return (new cljs.core.async.impl.channels.t17945(val__$1,box__$1,meta17946));
});
}
return (new cljs.core.async.impl.channels.t17945(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__4036__auto__,writer__4037__auto__,opts__4038__auto__){return cljs.core._write.call(null,writer__4037__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__4033__auto__,writer__4034__auto__,opt__4035__auto__){return cljs.core._write.call(null,writer__4034__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_17948 = self__.takes.pop();if((taker_17948 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_17948))
{var take_cb_17949 = cljs.core.async.impl.protocols.commit.call(null,taker_17948);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_17949,taker_17948){
return (function (){return take_cb_17949.call(null,null);
});})(take_cb_17949,taker_17948))
);
} else
{}
{
