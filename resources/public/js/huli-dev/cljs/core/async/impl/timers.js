...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4033__auto__,writer__4034__auto__,opt__4035__auto__){return cljs.core._write.call(null,writer__4034__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_17904 = 0;while(true){
if((i_17904 < arr.length))
{(arr[i_17904] = null);
{
var G__17905 = (i_17904 + 1);
i_17904 = G__17905;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4033__auto__,writer__4034__auto__,opt__4035__auto__){return cljs.core._write.call(null,writer__4034__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_17911 = (self__.level + 1);while(true){
if((i_17911 <= (new_level + 1)))
{(update[i_17911] = self__.header);
{
var G__17912 = (i_17911 + 1);
i_17911 = G__17912;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_17913 = 0;while(true){
if((i_17913 <= self__.level))
{var links_17914 = (update[i_17913]).forward;if(((links_17914[i_17913]) === x__$1))
{(links_17914[i_17913] = (x__$1.forward[i_17913]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3466__auto__ = (cljs.core.truth_((function (){var and__3454__auto__ = me;if(cljs.core.truth_(and__3454__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3454__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3466__auto__))
