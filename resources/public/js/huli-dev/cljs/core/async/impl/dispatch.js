...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_17939 = 0;while(true){
var m_17940 = cljs.core.async.impl.dispatch.tasks.pop();if((m_17940 == null))
{} else
{m_17940.call(null);
if((count_17939 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__17941 = (count_17939 + 1);
count_17939 = G__17941;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3454__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3454__auto__)
